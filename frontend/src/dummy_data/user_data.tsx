...
import { moduleAttempts } from "./modulesAttempt_data";
import { standardModule } from "./standard_data";
import { standardModuleAttempt } from "./standardAttempt_data";
...
export const employee: EmployeeUserType = {
    ...
    completedModules: [moduleAttempts[0]],
    modulesInProgress: [moduleAttempts[1], ...standardModuleAttempt],
    averageScore: 100,
    totalHours: 8.5,
    achievements: [
        {
...
export const janeCooper: EmployeeUserType = {
    email: "jane@cognition.ai",
